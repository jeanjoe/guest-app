...
<body class="antialiased">
    <div
        ...
        <h2 class="mt-6 text-7xl font-semibold text-gray-900 dark:text-white">Documentation</h2>


        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="flex justify-center">
                <div class="text-xl font-semibold text-gray-900 dark:text-white">WELCOME TO GUEST TICKETING APP</div>
            </div>
